...
function listarProductos() {
  $.ajax({
    url: '/tecweb/practica_1/actividades/a07/product_app2/backend/myapi/read/product-list.php',
      type: 'GET',
...
$('#search').on('keyup', function() {
  let search = $(this).val();
  $.ajax({
      url: './backend/myapi/read/product-search.php',
      type: 'GET',
      data: { search },
      success: function(response) {
          let productos = JSON.parse(response);
...
$('#product-form').submit(function(e) {
  ...
  if (id) {
      ...
      $.ajax({
          url: './backend/myapi/update/product-update.php',
          type: 'POST',
      ...
      $.ajax({
          url: './backend/myapi/create/product-add.php',
          type: 'POST',
          contentType: "application/json;charset=UTF-8",
...
$(document).on('click', '.product-delete', function() {
  if (confirm("¿De verdad deseas eliminar el producto?")) {
      ...
      $.ajax({
          url: './backend/myapi/delete/product-delete.php',
          type: 'POST',
          data: { id },
          success: function(response) {
              let respuesta = JSON.parse(response);
...
$(document).on('click', '.product-select', function(e) {
  ...
  $.ajax({
      url: './backend/myapi/read/product-get.php',
      type: 'GET',
      data: { id },
      success: function(response) {
